...
function ckcpt() {
    var cpt = '';
    cpt += 'definition.swf,2,2,-105,-30,2,1|';//清晰度插件
    cpt += 'downloadspeeds.swf,2,2,-450,-28,2|';//下载速度插件
    ...
    var ck = {
		...
		*/
		...
		/*
			跳过广告和播放结束时调用的js函数
		*/
        myweb: escape('793b98766effdd8756bad092e3694261,脱酷视频,http://www.tuokula.tk,v0.1'),
        /*
		------------------------------------------------------------------------------------------------------------------
